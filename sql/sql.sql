...
CREATE TABLE
    ticket (
        id INT NOT NULL AUTO_INCREMENT,
        fk_usuario INT NOT NULL,
        img_name VARCHAR(50) NOT NULL fecha_registro DATETIME NOT NULL,
        PRIMARY KEY (id),
        FOREIGN KEY (fk_usuario) REFERENCES usuario (id)
    );
...
values
    (
        ...
        "Admin",
        "849-878-0396",
        "fdisla1608@gmail.com",
        "root",
        "scrypt:32768:8:1$eRsclIwwjcZhxEgj$fa499124be6623255c9774d793f5ff78291c419e41b7a273f89891071d1d5475f3be27793fc708f328ddcdc4bd8113eb6b791e45105dd49b5af0571dcfbdbe20",
        "1998-10-16",
        NOW ()
    );
